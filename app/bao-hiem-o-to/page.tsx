      ...
      <section className="py-16 bg-white border-b border-slate-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { icon: <Zap className="w-8 h-8 text-[#D82D8B]" />, title: "Báo giá 30s", desc: "So sánh 11+ hãng bảo hiểm hàng đầu." },
              { icon: <ShieldCheck className="w-8 h-8 text-[#D82D8B]" />, title: "Bồi thường dễ", desc: "Quy trình online, nhận tiền qua MoMo." },
              { icon: <Headset className="w-8 h-8 text-[#D82D8B]" />, title: "Hỗ trợ 24/7", desc: "Chuyên gia luôn sẵn sàng đồng hành." },
              { icon: <CheckCircle2 className="w-8 h-8 text-[#D82D8B]" />, title: "Pháp lý chuẩn", desc: "Chứng chỉ số có giá trị toàn quốc." },
            ].map((usp, i) => (
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
                Các gói <span className="text-[#D82D8B]">Bảo hiểm Ô tô</span>
              </h2>
                ...
                <Card className="h-full border-none shadow-sm group-hover:shadow-xl transition-all duration-500 rounded-[2rem] overflow-hidden">
                  <CardContent className="p-0 flex flex-col md:flex-row">
                    ...
                    <div className="md:w-2/3 p-10 bg-white">
                      <h3 className="text-2xl font-bold mb-4 group-hover:text-[#D82D8B]">{type.name}</h3>
                      ...
                      <div className="flex justify-between items-center pt-6 border-t border-slate-50">
                        ...
                        <div className="text-[#D82D8B] font-black">Khám phá ngay →</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
