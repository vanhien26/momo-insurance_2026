      ...
      <div className="container mx-auto px-4">
        <ol className="flex items-center flex-wrap gap-2 text-sm">
          ...
          <li className="flex items-center gap-2">
            <Link 
              href="/bao-hiem" 
              className="text-slate-400 hover:text-momo-500 transition-colors flex items-center gap-1"
            >
          ...
          {items.map((item, i) => (
            <li key={item.href || i} className="flex items-center gap-2">
              ...
              {i === items.length - 1 ? (
                ...
                <Link
                  href={item.href || "#"}
                  className="text-slate-500 hover:text-momo-500 transition-colors whitespace-nowrap"
                >
                  {item.label}
                </Link>
              )}
